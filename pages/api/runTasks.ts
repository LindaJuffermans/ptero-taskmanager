...
const FilePull = (pteroConnection: PteroConnectionWrapper, task: FilePullTask) => {
  ...
  return new Promise<string>((resolve, reject) => {
    ...
    const [_, directory, filename] = task.properties.targetFile.match(pathWithFileRegex)!;
    const requestBody = {
...
const FileDecompress = (pteroConnection: PteroConnectionWrapper, task: FileDecompressTask) => {
  ...
  return new Promise<string>((resolve, reject) => {
    ...
    const [_, directory, filename] = task.properties.sourceFile.match(optionalPathWithFileRegex)!;
    const requestBody = {
      root: directory || '/',
      file: filename,
    };
